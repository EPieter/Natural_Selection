...
class Store(pg.sprite.Sprite):
    def __init__(self, game):
        ...
        text = font.render('Money', True, data.WHITE_TEXT)
        text_rect = (10 + 1.5 * 76, 5, 500, 24)
        self.image.blit(text, text_rect)
        text = font.render('People', True, data.WHITE_TEXT)
        text_rect = (10 + 3 * 76, 5, 500, 24)
        self.image.blit(text, text_rect)
        text = font.render('Production €/sp', True, data.WHITE_TEXT)
        text_rect = (10 + 4 * 76, 5, 500, 24)
        self.image.blit(text, text_rect)
        text = font.render('Limit workers', True, data.WHITE_TEXT)
