    ...
    def __init__(self, game):
        ...
        for i in range(1):
            for j in range(7):
                ...
                self.image.blit(text, text_rect)
                text = font.render(str(data.ToolStore.priceFormatterIncludeCalc(sprites.menu_items[j][4], ",.3f")), True, data.WHITE_TEXT) if sprites.menu_items[j][4] != 0 else font.render("n/a", True, data.WHITE_TEXT)
